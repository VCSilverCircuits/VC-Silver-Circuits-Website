    ...
    <>
      ...
      {latestEvent && (
        <section className="mb-16 border-t border-border pt-12">
          ...
          <h3 className="text-xl font-semibold text-accent mb-2">{latestEvent.summary}</h3>
            ...
            <section className="mb-16">
              <div className="relative overflow-hidden">
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <p className="text-sm font-medium text-accent uppercase tracking-wide mb-4 flex items-center">
            ...
            <section className="mb-16 border-t border-border pt-12">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                {achievements.map((achievement, index) => (
                  <div key={index} className="text-center tech-fade-in">
